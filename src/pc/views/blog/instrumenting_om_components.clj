...
(defn instrumenting-om-components []
  {:title "Instrumenting Om Components"
   ...
   [:div.post
    ...
    [:h2 "Visually indicating performance bottlenecks"]
    ...
    [:p " " [:video {:controls "", :src "/assets/video/paint-rectangles.mp4"}] " "]
    ...
    [:p " " [:video {:controls "", :src "/assets/video/render-colors.mp4"}] " "]
    ...
    [:p " " [:video {:controls "", :src "/assets/video/real-instrumentation.mp4"}] " "]
