(ns pc.views.scripts
  (:require [pc.profile :refer (prod-assets?)]
            [pc.rollbar :refer (rollbar-client-token)]))
...
<script>
  ...
  })(window,document,'script','//www.google-analytics.com/analytics.js','_google_analytics');

  _google_analytics('create', 'UA-56552392-1', 'auto');
  _google_analytics('send', 'pageview');
