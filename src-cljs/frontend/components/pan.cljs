        ...
        (if (and (get keyboard #{"space"})
          ...
          (dom/div #js {:className (str "pan-cursor "
                   ...
                   (dom/svg #js {:className "pan-cursor-icon"
                            ...
                            (dom/path #js {:fill "none"
                                           :stroke "black"
                                           :strokeWidth ".75"
                                           :d "M11.5,12.5V9.1 M9.5,9.1l0,3.5 M7.5,12.5l0-3.4"})))
