...
(def icon-paths
  {
   ...
   :stroke-docs "M85,95H35V25h50V95z M65,25V5H15v70h20"
   ...
   :fill-ph-logo "M64.2,42.5c0,4.1-3.4,7.5-7.5,7.5v0H42V35h14.7v0C60.8,35,64.2,38.4,64.2,42.5z M100,50 c0,27.6-22.4,50-50,50S0,77.6,0,50S22.4,0,50,0S100,22.4,100,50z M74.2,42.5c0-9.7-7.8-17.5-17.5-17.5v0L32,25v50h10V60h14.7v0 C66.3,60,74.2,52.2,74.2,42.5z"
   })
