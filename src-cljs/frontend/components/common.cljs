...
(def icon-paths
  {:precursor-stroke "M35.7,45.3V95 M60.5,84.4C82,78.6,94.8,56.5,89,34.9C83.2,13.4,61.1,0.6,39.5,6.4S5.2,34.3,11,55.9"
   ...
   :delete-stroke "M35,80L5,50c0,0,30-30,30-30s60,0,60,0v60 C95,80,35,80,35,80z M45,35l30,30 M75,35L45,65"
   ...
   :esc-stroke "M95,46.6c-3.2-3.2-7.4-4.8-11.7-4.8 c-9.1,0-16.5,7.4-16.5,16.5s7.4,16.5,16.5,16.5c4.2,0,8.4-1.6,11.7-4.8 M40.4,72.3c1.6,1.6,3.7,2.4,5.8,2.4c4.6,0,8.2-3.7,8.2-8.2 s-3.7-8.2-8.2-8.2S38,54.6,38,50s3.7-8.2,8.2-8.2c2.1,0,4.2,0.8,5.8,2.4 M29.7,74.7H5c0,0,0-49.5,0-49.5h24.7 M5,50h18.6"
   :scroll-stroke "M65,20L50,5L35,20 M65,35L50,20L35,35 M35,80l15,15 l15-15 M35,65l15,15l15-15 M35,50l15,15l15-15c0,0-15-15-15-15S35,50,35,50z"
   ...
   :mouse-stroke "M58,5h17c2.8,0,5,2.2,5,5v55c0,16.6-13.4,30-30,30 S20,81.6,20,65V10c0-2.8,2.2-5,5-5h20c2.8,0,5,2.2,5,5c0,0,0,25,0,25"
   ...
   :up-down-fill "M55,80H45V20h10V80z"
   :left-right-fill "M80,55H20V45h60V55z"
   :north-fill "M30,20L50,0l20,20H30z"
   :south-fill "M70,80l-20,20L30,80H70z"
   :east-fill "M80,30l20,20L80,70V30z"
   :west-fill "M20,70L0,50l20-20V70z"
   })
...
(def icon-templates
  {:precursor {:paths [:precursor-stroke]}
   ...
   :mouse {:paths [:mouse-stroke]}
   :globe {:paths [:globe-stroke]}
   :lock {:paths [:lock-top-stroke :lock-bottom-fill]}
   :twitter {:paths [:twitter-fill]}
   :google {:paths [:google-fill]}
   :newdoc {:paths [:newdoc-stroke]}
   :login {:paths [:login-stroke]}
   :logout {:paths [:logout-stroke]}
   :info {:paths [:info-stroke]}
   :north {:paths [:up-down-fill :north-fill]}
   :south {:paths [:up-down-fill :south-fill]}
   :north-south {:paths [:up-down-fill :north-fill :south-fill]}
   :east {:paths [:left-right-fill :east-fill]}
   :west {:paths [:left-right-fill :west-fill]}
   :east-west {:paths [:left-right-fill :east-fill :west-fill]}
   })
