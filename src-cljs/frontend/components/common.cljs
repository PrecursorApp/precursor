...
(def icon-paths
  {:logomark-precursor-stroke "M35.7,45.3V95 M60.5,84.4C82,78.6,94.8,56.5,89,34.9C83.2,13.4,61.1,0.6,39.5,6.4S5.2,34.3,11,55.9"
   ...
   ; :menu-stroke "M95,18.2H5 M95,50H5 M5,81.8h90"
   :menu-stroke-top "M5,25h90"
   :menu-stroke-middle "M5,50h90"
   :menu-stroke-bottom "M5,75h90"
   :newdoc-stroke "M56,80V50 M41,65h30 M14,77c0,0,0-52,0-52 c0,0,20-20,20-20s34,0,34,0v18 M56,35c-16.6,0-30,13.4-30,30s13.4,30,30,30s30-13.4,30-30S72.6,35,56,35z M14,25h20V5"
   :login-stroke "M15,5h80v90H15 M48.6,73.9L72.5,50L48.6,26.1 M72.5,50 H5"
   :logout-stroke "M15,5h80v90H15 M28.9,26.1L5,50l23.9,23.9 M5,50 l67.5,0"
